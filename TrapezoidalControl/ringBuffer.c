...
extern inline unsigned char ring_buffer_is_empty(ring_buffer_t *buffer);
extern inline unsigned char ring_buffer_is_full(ring_buffer_t *buffer);
extern inline unsigned char ring_buffer_num_items(ring_buffer_t *buffer);
