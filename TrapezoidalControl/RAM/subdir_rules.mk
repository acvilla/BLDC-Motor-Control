...
user.obj: ../user.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: C2000 Compiler'
	"C:/ti/ccsv8/tools/compiler/ti-cgt-c2000_18.1.2.LTS/bin/cl2000" -v28 -ml -mt -O4 --fp_mode=relaxed --fp_reassoc=off --include_path="C:/ti/ccsv8/tools/compiler/ti-cgt-c2000_18.1.2.LTS/include" --include_path="C:/ti/C2000Ware_1_00_04_00_Software/device_support/f2802x/common/include" --include_path="C:/ti/C2000Ware_1_00_04_00_Software/device_support/f2802x/headers/include" --include_path="C:/ti/C2000Ware_1_00_04_00_Software/device_support/f2802x" --include_path="C:/ti/C2000Ware_1_00_04_00_Software/libraries/math/IQmath/c28/include" --advice:performance=all --define="_DEBUG" --define="LARGE_MODEL" -g --diag_suppress=10063 --diag_warning=225 --verbose_diagnostics --quiet -ms --preproc_with_compile --preproc_dependency="user.d_raw" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
